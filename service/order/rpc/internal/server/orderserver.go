...
import (
	...
	"snai.micro.mall/service/order/rpc/internal/logic"
...
func (s *OrderServer) LastOne(ctx context.Context, in *order.LastOneRequest) (*order.LastOneResponse, error) {
	l := logic.NewLastOneLogic(ctx, s.svcCtx)
	return l.LastOne(in)
}
