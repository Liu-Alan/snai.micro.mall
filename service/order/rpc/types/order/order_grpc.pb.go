...
const (
	...
	Order_LastOne_FullMethodName      = "/order.Order/LastOne"
...
func (c *orderClient) LastOne(ctx context.Context, in *LastOneRequest, opts ...grpc.CallOption) (*LastOneResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LastOneResponse)
	err := c.cc.Invoke(ctx, Order_LastOne_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	LastOne(context.Context, *LastOneRequest) (*LastOneResponse, error)
...
func (UnimplementedOrderServer) LastOne(context.Context, *LastOneRequest) (*LastOneResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LastOne not implemented")
}
...
func _Order_LastOne_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LastOneRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).LastOne(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_LastOne_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).LastOne(ctx, req.(*LastOneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LastOne",
			Handler:    _Order_LastOne_Handler,
		},
		{
			MethodName: "Paid",
